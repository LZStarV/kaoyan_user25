...
Page({
  ...
  data: {
    ...
    belongType: ['全部', '教育部直属', '其他中央部委', '地方所属'],
    collegeType: [
      {
        name: '全部',
        param: '',
  ...
  click_type(e) {
    const currentType = e.currentTarget.dataset.index;
  ...
  click_province(e) {
    const currentProvinceIndex = e.currentTarget.dataset.index;
    this.setData({
      currentProvinceIndex,
      'requestCollegeData.location':
        currentProvinceIndex === 0
          ? ''
          : this.data.province[currentProvinceIndex],
      collegeList: [],
      'requestCollegeData.page': 1,
    });
    this.getCollegeList();
  ...
  click_subject_type(e) {
    const currentSubject = e.currentTarget.dataset.index;
    this.setData({
      currentSubject,
  ...
  click_belong_type(e) {
    const currentBelong = e.currentTarget.dataset.index;
    this.setData({
      currentBelong,
