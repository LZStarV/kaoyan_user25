...
Page({
  ...
  data: {
    ...
    type_of_subjects_all: {
      ...
      军事学: [
        { id: '0', name: '全部' },
        { id: '1152', name: '联合作战指挥' },
        { id: '1153', name: '军兵种作战指挥' },
        { id: '1154', name: '作战指挥保障' },
        { id: '1155', name: '战时政治工作' },
        { id: '1156', name: '后勤与装备保障' },
        { id: '1157', name: '军事训练与管理' },
      ],
      管理学: [
        { id: '0', name: '全部' },
        { id: '1251', name: '工商管理' },
  ...
  async getLineDataList() {
    ...
    const selectedFieldId =
      this.data.selectedSubjectIndex === '0'
        ? ''
        : this.data.selectedSubjectIndex;
    const selectedDisciplineId =
      this.data.type_of_subjects_sub[this.data.selectedSubjectSubIndex].id ===
      '0'
        ? ''
        : this.data.type_of_subjects_sub[this.data.selectedSubjectSubIndex].id;
    // 更新请求参数对象
    ...
    this.setData({
      records:
        this.data.requestLineData.page === '1'
          ? data.records
  ...
  selectSubjectIndex: function (e) {
    ...
    if (this.data.sub_or_not) {
      this.setData({
        type_of_subjects_sub:
          this.data.type_of_subjects_all[
            this.data.type_of_subjects[e.currentTarget.dataset.index].name
          ],
      });
    }
    this.setData({
