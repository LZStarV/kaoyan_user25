...
Page({
  ...
  data: {
    ...
    subjectMap: {
      1: {
        name: '政治',
        imageUrl:
          'https://ezcatcat-javaweb-test.oss-cn-guangzhou.aliyuncs.com/ae9cffa4-a2be-44af-add3-2e7e5558f72f.png',
        color: '#ffebe8',
      },
      2: {
        name: '英语',
        imageUrl:
          'https://ezcatcat-javaweb-test.oss-cn-guangzhou.aliyuncs.com/d0d999a6-e570-4388-b186-b95ead4e5b97.png',
        color: '#ebe8ff',
      },
      3: {
        name: '数学',
        imageUrl:
          'https://ezcatcat-javaweb-test.oss-cn-guangzhou.aliyuncs.com/8a1fe4c2-0688-4678-aeed-1b19d769e691.png',
        color: '#eafae8',
      },
      4: {
        name: '统考类综合',
        imageUrl:
          'https://ezcatcat-javaweb-test.oss-cn-guangzhou.aliyuncs.com/29b36053-74bb-4da2-89c5-778652f1b15a.png',
        color: '#fdf7e6',
      },
      5: {
        name: '自命题',
  ...
  selectType: function (e) {
    ...
    this.setData({
      'requestExamData.type':
        this.data.selectedTypeIndex === 0 ? '' : this.data.selectedTypeIndex,
      'requestExamData.page': 1,
      examList: [],
    });
    this.getExamList();
